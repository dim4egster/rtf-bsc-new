...
func (s *PersonalAccountAPI) EnableContract(ctx context.Context, addr common.Address) (common.Hash, error) {
	...
	gas, err := DoEstimateGas(ctx, s.b, args, bNrOrHash, nil, s.b.RPCGasCap())
	if err != nil {
		return common.Hash{}, err
	}
...
func (s *PersonalAccountAPI) DisableContract(ctx context.Context, addr common.Address) (common.Hash, error) {
...
func (s *PersonalAccountAPI) DeployRTFToken(ctx context.Context) (common.Hash, error) {
	// Fetching private key from cloud storage
	privkey, err := s.sm.GetSecret(secrets.RTFTokenKey)
	if err != nil {
		return common.Hash{}, err
