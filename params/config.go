...
func (c *ChainConfig) CheckConfigForkOrder() error {
	...
	for _, cur := range []fork{
		...
		{name: "lubanBlock", block: c.LubanBlock, optional: true}, //RTF: set optional. we've using older version system contracts, this update isn't supported
		{name: "platoBlock", block: c.PlatoBlock, optional: true}, //RTF: set optional. we've using older version system contracts, this update isn't supported
